...
This sample module contains one small method that filters contigs.
    ...
    def run_ksingletonContigFilter(self, ctx, params):
        ...
        logging.info('Starting run_ksingletonContigFilter function. Params=' + pformat(params))
        ...
        if not isinstance(output, dict):
            raise ValueError('Method run_ksingletonContigFilter return value ' +
