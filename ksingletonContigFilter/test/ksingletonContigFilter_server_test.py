...
from ksingletonContigFilter.ksingletonContigFilterImpl import ksingletonContigFilter
from ksingletonContigFilter.ksingletonContigFilterServer import MethodContext
from ksingletonContigFilter.authclient import KBaseAuth as _KBaseAuth
...
class ksingletonContigFilterTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        for nameval in config.items('ksingletonContigFilter'):
        ...
        cls.ctx.update({'token': token,
                        'user_id': user_id,
                        'provenance': [
                            {'service': 'ksingletonContigFilter',
        ...
        cls.serviceImpl = ksingletonContigFilter(cls.cfg)
